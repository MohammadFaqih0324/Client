...
import com.client.model.request.AddRoomRequest;
...
public class RoomController {
    ...
    @GetMapping("/resttemplate/get-all-room")
    ...
    @GetMapping("/resttemplate-pojo/get-all-room")
    public GeneralResponse<List<Room>> getAllRoomRestTemplatePojoResponse(){
        log.info("incoming request get all room");
        try {
            String url = smartHomeStayBaseUrl.concat("/room");
            ParameterizedTypeReference<GeneralResponse<List<Room>>> responseType = new ParameterizedTypeReference<>() {};
    ...
    public Object addRoom(@RequestBody AddRoomRequest addRoomRequest){
        log.info("incoming request create room");
        try {
...
//            addRoomRequest.setFloor("1");
            ...
            // set response body
            ParameterizedTypeReference<GeneralResponse<Room>> responseBody = new ParameterizedTypeReference<GeneralResponse<Room>>() {};
